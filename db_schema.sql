...
INSERT INTO submissions (title, content, submission_type, disclaimer, author, author_instagram, author_bio, created_at) VALUES
('The Dawn of Spring', '<p>This is a beautiful poem about spring.</p>', 'poetry', NULL, 'Jane Doe', '@jane_doe', 'Jane Doe is a writer.', NOW() - INTERVAL '10 days'),
('Reflections on Society', '<p>An essay reflecting on modern social issues.</p>', 'shortstories', 'Views are personal.', 'John Smith', '@johnsmith', 'John Smith is a good writer.', NOW() - INTERVAL '5 days'),
('Short Story: The Lost City', '<p>A thrilling adventure story about a lost city.</p>', 'essays', NULL, 'Anonymous Writer', NULL, NULL, NOW() - INTERVAL '2 days');
